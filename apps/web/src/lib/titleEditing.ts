 ...
 * override toggle. The color/size defaults match the schema's so a freshly-toggled title round-trips
 * through validation identically. Turning it off removes the `title` key entirely.
 */
